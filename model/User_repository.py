...
#================SETTERS=======================# 
    ...
    def set_overdraft(self, user_id, overdraft):
        """
        ...
        """
        query = "UPDATE user SET overdraft = %s WHERE id = %s"
        self.db.execute(query, (overdraft, user_id))
        return True
#================AUTHENTICATION=======================#
